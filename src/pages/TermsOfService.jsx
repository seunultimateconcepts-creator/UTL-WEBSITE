        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 text-gray-700 text-sm leading-relaxed">
          ...
          <div>
            <p>
              ...
              related services, including U Market, U Tech Hub, and our web development, crypto
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>U Market,</strong> a marketplace where independent, verified vendors list and sell their own products. UTL acts as an intermediary platform for these listings — see Section 5 for details on our role.</li>
          ...
          <div>
            <h2 className="text-gray-900 font-black text-xl mb-3">5. U Market — Marketplace Terms</h2>
            <p className="mb-3">
              U Market allows independent vendors ("Vendors") to list and sell products to buyers
          ...
          <div>
            ...
            <p>
              Product questions on U Market are answered first by an AI assistant, grounded in the
          ...
          <div>
            ...
            <p>
              ...
              part of the U Market marketplace or subject to Section 5 above. Cryptocurrency trading
          ...
          <div>
            ...
            <p>
              ...
              license to display that content on the Platform for the purpose of operating U Market.
            </p>
          </div>
